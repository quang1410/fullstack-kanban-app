    ...
    create: async (req, res) => {
      ...
      try {
        ...
        return res.status(500).json({
          statusCode: 500,
          message:
            err.message || `Some errors occur while creating new ${Model}`,
        });
      }
    },
    find: async (req, res) => {
      try {
        ...
        return res.status(500).json({
          statusCode: 500,
          message:
            err.message || `Some errors occur while finding ${Model} list`,
        });
      }
    },
    findOne: async (req, res) => {
      ...
      try {
        ...
        return res.status(500).json({
          ...
          message:
            err.message ||
            `Some errors occur while finding ${Model} with ID ${id}`,
        });
      }
    },
    update: async (req, res) => {
      ...
      try {
        ...
        return res.status(500).json({
          ...
          message:
            err.message ||
            `Some errors occur while updating ${Model} with ID ${id}`,
        });
      }
    },
